...
in_csv = ROOT_PATH + '/synth_tubules/synth_mbprot.csv'
tomo_dir = ROOT_PATH + '/synth_tubules'
out_dir = ROOT_PATH + '/out_sfields_synth_mbprot_reg'
sigma = 8  # voxels
order = 2 # Gaussian derivative order
mt_dst = 12 # 12 # 14  # voxels
...
train_set = {'tomo_rec_0',
             ...
             'tomo_rec_8',
             'tomo_rec_9'}
valid_set = {'tomo_rec_2',
             'tomo_rec_5'} # {'0_25h_20220420_333c_tomo09', '0_25h_20220420_333c_tomo04'}

# TM Background
cc_dir = None # ROOT_PATH + '/tm'
...
for tomo_name in tomos_set:
    ...
    tomo_bare_name = os.path.splitext(tomo_name)[0]
    ...
    write_mrc((tomo_mt_dst).astype(np.float32), out_dir + '/' + out_tomo + '_idx_' + str(idx) + '_mbprot_dst.mrc')
...
if add_bg:
    ol.write_xml(objects_list_train, out_dir + '/train_objlist_bg.xml')
    ol.write_xml(objects_list_valid, out_dir + '/valid_objlist_bg.xml')
else:
